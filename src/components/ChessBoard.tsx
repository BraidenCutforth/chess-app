...
class ChessBoard extends React.Component<{}, ChessBoardState>{
    ...
    lastClick: {
        tile: string,
        moves: ChessInterfaces.Move[] | string[];
    }
    constructor({ }) {
        super({});
        ...
        this.state = {
            tiles: {
                a8: this.cloneTileInfo(startState), b8: this.cloneTileInfo(startState), c8: this.cloneTileInfo(startState), d8: this.cloneTileInfo(startState), e8: this.cloneTileInfo(startState), f8: this.cloneTileInfo(startState), g8: this.cloneTileInfo(startState), h8: this.cloneTileInfo(startState),
                a7: this.cloneTileInfo(startState), b7: this.cloneTileInfo(startState), c7: this.cloneTileInfo(startState), d7: this.cloneTileInfo(startState), e7: this.cloneTileInfo(startState), f7: this.cloneTileInfo(startState), g7: this.cloneTileInfo(startState), h7: this.cloneTileInfo(startState),
                a6: this.cloneTileInfo(startState), b6: this.cloneTileInfo(startState), c6: this.cloneTileInfo(startState), d6: this.cloneTileInfo(startState), e6: this.cloneTileInfo(startState), f6: this.cloneTileInfo(startState), g6: this.cloneTileInfo(startState), h6: this.cloneTileInfo(startState),
                a5: this.cloneTileInfo(startState), b5: this.cloneTileInfo(startState), c5: this.cloneTileInfo(startState), d5: this.cloneTileInfo(startState), e5: this.cloneTileInfo(startState), f5: this.cloneTileInfo(startState), g5: this.cloneTileInfo(startState), h5: this.cloneTileInfo(startState),
                a4: this.cloneTileInfo(startState), b4: this.cloneTileInfo(startState), c4: this.cloneTileInfo(startState), d4: this.cloneTileInfo(startState), e4: this.cloneTileInfo(startState), f4: this.cloneTileInfo(startState), g4: this.cloneTileInfo(startState), h4: this.cloneTileInfo(startState),
                a3: this.cloneTileInfo(startState), b3: this.cloneTileInfo(startState), c3: this.cloneTileInfo(startState), d3: this.cloneTileInfo(startState), e3: this.cloneTileInfo(startState), f3: this.cloneTileInfo(startState), g3: this.cloneTileInfo(startState), h3: this.cloneTileInfo(startState),
                a2: this.cloneTileInfo(startState), b2: this.cloneTileInfo(startState), c2: this.cloneTileInfo(startState), d2: this.cloneTileInfo(startState), e2: this.cloneTileInfo(startState), f2: this.cloneTileInfo(startState), g2: this.cloneTileInfo(startState), h2: this.cloneTileInfo(startState),
                a1: this.cloneTileInfo(startState), b1: this.cloneTileInfo(startState), c1: this.cloneTileInfo(startState), d1: this.cloneTileInfo(startState), e1: this.cloneTileInfo(startState), f1: this.cloneTileInfo(startState), g1: this.cloneTileInfo(startState), h1: this.cloneTileInfo(startState),
    ...
    getBoardFromFen(fen: string) {
        ...
        console.log(board);
        for (let key in this.state.tiles) {
            this.state.tiles[key].piece = board[i];
            i++;
        }
    ...
    onClick = (tileCoord: string) => {
        ...
        // TODO Refactor so when you click a tile,
        // if it is not in moves then make it last clicked
        console.log("Coordinate Clicked: ", tileCoord);
        console.log("Piece: ", this.chess.get(tileCoord));
        console.log("Moves: ", this.getMoves(tileCoord));
        if (!this.lastClick.tile) {
            this.lastClick.tile = tileCoord;
            const moves = this.getMoves(tileCoord);
            this.lastClick.moves = moves;
            this.setHighlight(moves);
            if (this.lastClick.moves.length < 1) {
                this.lastClick.tile = "";
                console.log("No moves...");
                //console.log("First Click:\n", this.lastClick);
            }
        } else {
            const move = this.chess.move({ from: this.lastClick.tile, to: tileCoord });
            if (!move) {
                // alert("The move was invalid")
                console.log("Invalid move, should not end up here");
                console.log("Tile Coord", tileCoord, "\nLastClick.moves: ", this.lastClick.moves);
            } else {
